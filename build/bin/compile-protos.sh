...
go_import_paths="${go_import_paths},Monos/misc/misc.proto=github.com/nfvri/onos-api/go/onos/misc"
go_import_paths="${go_import_paths},Monos/config/device/types.proto=github.com/nfvri/onos-api/go/onos/config/device"
go_import_paths="${go_import_paths},Monos/config/admin/admin.proto=github.com/nfvri/onos-api/go/onos/config/admin"
go_import_paths="${go_import_paths},Monos/ransim/types/types.proto=github.com/nfvri/onos-api/go/onos/ransim/types"
go_import_paths="${go_import_paths},Monos/config/v2/object.proto=github.com/nfvri/onos-api/go/onos/config/v2"
go_import_paths="${go_import_paths},Monos/config/v2/failure.proto=github.com/nfvri/onos-api/go/onos/config/v2"
go_import_paths="${go_import_paths},Monos/config/v2/value.proto=github.com/nfvri/onos-api/go/onos/config/v2"
go_import_paths="${go_import_paths},Monos/config/v2/transaction.proto=github.com/nfvri/onos-api/go/onos/config/v2"
go_import_paths="${go_import_paths},Monos/config/v2/proposal.proto=github.com/nfvri/onos-api/go/onos/config/v2"
go_import_paths="${go_import_paths},Monos/config/v2/configuration.proto=github.com/nfvri/onos-api/go/onos/config/v2"
go_import_paths="${go_import_paths},Monos/config/v3/admin.proto=github.com/nfvri/onos-api/go/onos/config/v3"
go_import_paths="${go_import_paths},Monos/config/v3/object.proto=github.com/nfvri/onos-api/go/onos/config/v3"
go_import_paths="${go_import_paths},Monos/config/v3/failure.proto=github.com/nfvri/onos-api/go/onos/config/v3"
go_import_paths="${go_import_paths},Monos/config/v3/value.proto=github.com/nfvri/onos-api/go/onos/config/v3"
go_import_paths="${go_import_paths},Monos/config/v3/transaction.proto=github.com/nfvri/onos-api/go/onos/config/v3"
go_import_paths="${go_import_paths},Monos/config/v3/configuration.proto=github.com/nfvri/onos-api/go/onos/config/v3"
