...
import (
	...
	misc "github.com/nfvri/onos-api/go/onos/misc"
...
const (
	HostType_BARE_METAL HostType = 0
	HostType_VIRTUAL    HostType = 1
)
...
type Host struct {
	...
	Type HostType `protobuf:"varint,4,opt,name=type,proto3,enum=onos.fabricsim.HostType" json:"type,omitempty"`
	// network interfaces
	Interfaces []*NetworkInterface `protobuf:"bytes,2,rep,name=interfaces,proto3" json:"interfaces,omitempty"`
	Pos        *misc.GridPosition  `protobuf:"bytes,3,opt,name=pos,proto3" json:"pos,omitempty"`
...
func (m *Host) GetType() HostType {
	if m != nil {
		return m.Type
	}
	return HostType_BARE_METAL
}
...
func (m *Host) GetPos() *misc.GridPosition {
	if m != nil {
		return m.Pos
	}
	return nil
...
type AddHostRequest struct {
	Host     *Host  `protobuf:"bytes,1,opt,name=host,proto3" json:"host,omitempty"`
	HostedBy HostID `protobuf:"bytes,2,opt,name=hosted_by,json=hostedBy,proto3,casttype=HostID" json:"hosted_by,omitempty"`
}
...
func (m *AddHostRequest) GetHostedBy() HostID {
	if m != nil {
		return m.HostedBy
	}
	return ""
...
func init() {
	proto.RegisterEnum("onos.fabricsim.HostType", HostType_name, HostType_value)
...
var fileDescriptor_032be33f3739b3f8 = []byte{
	...
	,
}
...
func (m *Host) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.Type != 0 {
		i = encodeVarintHosts(dAtA, i, uint64(m.Type))
		i--
		dAtA[i] = 0x20
	}
	if m.Pos != nil {
...
func (m *NetworkInterface) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.VLAN != 0 {
		i = encodeVarintHosts(dAtA, i, uint64(m.VLAN))
		i--
		dAtA[i] = 0x30
	}
	if m.Behavior != nil {
...
func (m *AddHostRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.HostedBy) > 0 {
		i -= len(m.HostedBy)
		copy(dAtA[i:], m.HostedBy)
		i = encodeVarintHosts(dAtA, i, uint64(len(m.HostedBy)))
		i--
		dAtA[i] = 0x12
	}
	if m.Host != nil {
...
func (m *AddHostRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field HostedBy", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.HostedBy = HostID(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipHosts(dAtA[iNdEx:])
