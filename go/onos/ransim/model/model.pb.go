...
import (
	...
	github_com_nfvri_onos_api_go_onos_ransim_types "github.com/nfvri/onos-api/go/onos/ransim/types"
	types1 "github.com/nfvri/onos-api/go/onos/ransim/types"
...
type ModelInfoResponse struct {
	...
	CreationTimestamp time.Time `protobuf:"bytes,2,opt,name=creationTimestamp,proto3,stdtime" json:"creationTimestamp"`
}
...
func (m *ModelInfoResponse) GetSnapshotID() string {
	if m != nil {
		return m.SnapshotID
	}
	return ""
...
func (m *ModelInfoResponse) GetCreationTimestamp() time.Time {
	if m != nil {
...
type PlmnIDResponse struct {
	PlmnID github_com_nfvri_onos_api_go_onos_ransim_types.PlmnID `protobuf:"varint,1,opt,name=plmnid,proto3,casttype=github.com/nfvri/onos-api/go/onos/ransim/types.PlmnID" json:"plmnid,omitempty"`
}
...
func (m *PlmnIDResponse) GetPlmnID() github_com_nfvri_onos_api_go_onos_ransim_types.PlmnID {
	if m != nil {
		return m.PlmnID
	}
	return 0
...
type CreateNodeRequest struct {
	Node *types1.Node `protobuf:"bytes,1,opt,name=node,proto3" json:"node,omitempty"`
}
...
func (m *CreateNodeRequest) GetNode() *types1.Node {
	if m != nil {
		return m.Node
	}
	return nil
...
type GetNodeRequest struct {
	GnbID github_com_nfvri_onos_api_go_onos_ransim_types.GnbID `protobuf:"varint,1,opt,name=enbid,proto3,casttype=github.com/nfvri/onos-api/go/onos/ransim/types.GnbID" json:"enbid,omitempty"`
}
...
func (m *GetNodeRequest) GetGnbID() github_com_nfvri_onos_api_go_onos_ransim_types.GnbID {
	if m != nil {
		return m.GnbID
	}
	return 0
...
func (m *GetNodeResponse) GetNode() *types1.Node {
	if m != nil {
		return m.Node
	}
	return nil
...
func (m *UpdateNodeRequest) GetNode() *types1.Node {
	if m != nil {
		return m.Node
	}
	return nil
...
func (m *DeleteNodeRequest) GetGnbID() github_com_nfvri_onos_api_go_onos_ransim_types.GnbID {
	if m != nil {
		return m.GnbID
	}
	return 0
...
func (m *ListNodesResponse) GetNode() *types1.Node {
	if m != nil {
		return m.Node
	}
	return nil
...
func (m *WatchNodesResponse) GetNode() *types1.Node {
	if m != nil {
		return m.Node
	}
	return nil
...
func (m *AgentControlRequest) GetGnbID() github_com_nfvri_onos_api_go_onos_ransim_types.GnbID {
	if m != nil {
		return m.GnbID
	}
	return 0
...
func (m *AgentControlResponse) GetNode() *types1.Node {
	if m != nil {
		return m.Node
	}
	return nil
...
type CreateCellRequest struct {
	Cell *types1.Cell `protobuf:"bytes,1,opt,name=cell,proto3" json:"cell,omitempty"`
}
...
func (m *CreateCellRequest) GetCell() *types1.Cell {
	if m != nil {
		return m.Cell
	}
	return nil
...
type GetCellRequest struct {
	NCGI github_com_nfvri_onos_api_go_onos_ransim_types.NCGI `protobuf:"varint,1,opt,name=ecgi,proto3,casttype=github.com/nfvri/onos-api/go/onos/ransim/types.NCGI" json:"ecgi,omitempty"`
}
...
func (m *GetCellRequest) GetNCGI() github_com_nfvri_onos_api_go_onos_ransim_types.NCGI {
	if m != nil {
		return m.NCGI
	}
	return 0
...
func (m *GetCellResponse) GetCell() *types1.Cell {
	if m != nil {
		return m.Cell
	}
	return nil
...
func (m *UpdateCellRequest) GetCell() *types1.Cell {
	if m != nil {
		return m.Cell
	}
	return nil
...
type DeleteCellRequest struct {
	NCGI github_com_nfvri_onos_api_go_onos_ransim_types.NCGI `protobuf:"varint,1,opt,name=enbid,proto3,casttype=github.com/nfvri/onos-api/go/onos/ransim/types.NCGI" json:"enbid,omitempty"`
}
...
func (m *DeleteCellRequest) GetNCGI() github_com_nfvri_onos_api_go_onos_ransim_types.NCGI {
	if m != nil {
		return m.NCGI
	}
	return 0
...
func (m *WatchCellsResponse) GetCell() *types1.Cell {
	if m != nil {
		return m.Cell
	}
	return nil
...
type ListPatchedCellsRequest struct {
}

func (m *ListPatchedCellsRequest) Reset()         { *m = ListPatchedCellsRequest{} }
func (m *ListPatchedCellsRequest) String() string { return proto.CompactTextString(m) }
func (*ListPatchedCellsRequest) ProtoMessage()    {}
func (*ListPatchedCellsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_9942ba2f94296ec8, []int{33}
}
func (m *ListPatchedCellsRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ListPatchedCellsRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ListPatchedCellsRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *ListPatchedCellsRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ListPatchedCellsRequest.Merge(m, src)
}
func (m *ListPatchedCellsRequest) XXX_Size() int {
	return m.Size()
}
func (m *ListPatchedCellsRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_ListPatchedCellsRequest.DiscardUnknown(m)
}

var xxx_messageInfo_ListPatchedCellsRequest proto.InternalMessageInfo
...
func (m *ListCellsResponse) GetCell() *types1.Cell {
	if m != nil {
		return m.Cell
	}
	return nil
...
type CreateRouteRequest struct {
	Route *types1.Route `protobuf:"bytes,1,opt,name=route,proto3" json:"route,omitempty"`
}
...
func (m *CreateRouteRequest) GetRoute() *types1.Route {
	if m != nil {
		return m.Route
	}
	return nil
...
type GetRouteRequest struct {
	IMSI github_com_nfvri_onos_api_go_onos_ransim_types.IMSI `protobuf:"varint,1,opt,name=imsi,proto3,casttype=github.com/nfvri/onos-api/go/onos/ransim/types.IMSI" json:"imsi,omitempty"`
}
...
func (m *GetRouteRequest) GetIMSI() github_com_nfvri_onos_api_go_onos_ransim_types.IMSI {
	if m != nil {
		return m.IMSI
	}
	return 0
...
func (m *GetRouteResponse) GetRoute() *types1.Route {
	if m != nil {
		return m.Route
	}
	return nil
...
type DeleteRouteRequest struct {
	IMSI github_com_nfvri_onos_api_go_onos_ransim_types.IMSI `protobuf:"varint,1,opt,name=enbid,proto3,casttype=github.com/nfvri/onos-api/go/onos/ransim/types.IMSI" json:"enbid,omitempty"`
}
...
func (m *DeleteRouteRequest) GetIMSI() github_com_nfvri_onos_api_go_onos_ransim_types.IMSI {
	if m != nil {
		return m.IMSI
	}
	return 0
...
func (m *WatchRoutesResponse) GetRoute() *types1.Route {
	if m != nil {
		return m.Route
	}
	return nil
...
func (m *ListRoutesResponse) GetRoute() *types1.Route {
	if m != nil {
		return m.Route
	}
	return nil
...
func (m *GetUERequest) GetIMSI() github_com_nfvri_onos_api_go_onos_ransim_types.IMSI {
	if m != nil {
		return m.IMSI
	}
	return 0
...
type GetUEResponse struct {
	Ue *types1.Ue `protobuf:"bytes,1,opt,name=ue,proto3" json:"ue,omitempty"`
}
...
func (m *GetUEResponse) GetUe() *types1.Ue {
	if m != nil {
		return m.Ue
	}
	return nil
...
type MoveToCellRequest struct {
	IMSI github_com_nfvri_onos_api_go_onos_ransim_types.IMSI `protobuf:"varint,1,opt,name=imsi,proto3,casttype=github.com/nfvri/onos-api/go/onos/ransim/types.IMSI" json:"imsi,omitempty"`
	NCGI github_com_nfvri_onos_api_go_onos_ransim_types.NCGI `protobuf:"varint,2,opt,name=ecgi,proto3,casttype=github.com/nfvri/onos-api/go/onos/ransim/types.NCGI" json:"ecgi,omitempty"`
}
...
func (m *MoveToCellRequest) GetIMSI() github_com_nfvri_onos_api_go_onos_ransim_types.IMSI {
	if m != nil {
		return m.IMSI
	}
	return 0
...
func (m *MoveToCellRequest) GetNCGI() github_com_nfvri_onos_api_go_onos_ransim_types.NCGI {
	if m != nil {
		return m.NCGI
	}
	return 0
...
type MoveToLocationRequest struct {
	IMSI     github_com_nfvri_onos_api_go_onos_ransim_types.IMSI `protobuf:"varint,1,opt,name=imsi,proto3,casttype=github.com/nfvri/onos-api/go/onos/ransim/types.IMSI" json:"imsi,omitempty"`
	Location *types1.Coordinate                                  `protobuf:"bytes,2,opt,name=location,proto3" json:"location,omitempty"`
...
func (m *MoveToLocationRequest) GetIMSI() github_com_nfvri_onos_api_go_onos_ransim_types.IMSI {
	if m != nil {
		return m.IMSI
	}
	return 0
...
func (m *MoveToLocationRequest) GetLocation() *types1.Coordinate {
	if m != nil {
		return m.Location
	}
	return nil
...
func (m *DeleteUERequest) GetIMSI() github_com_nfvri_onos_api_go_onos_ransim_types.IMSI {
	if m != nil {
		return m.IMSI
	}
	return 0
...
func (m *WatchUEsResponse) GetUe() *types1.Ue {
	if m != nil {
		return m.Ue
	}
	return nil
...
type ListPatchedUEsRequest struct {
}

func (m *ListPatchedUEsRequest) Reset()         { *m = ListPatchedUEsRequest{} }
func (m *ListPatchedUEsRequest) String() string { return proto.CompactTextString(m) }
func (*ListPatchedUEsRequest) ProtoMessage()    {}
func (*ListPatchedUEsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_9942ba2f94296ec8, []int{56}
}
func (m *ListPatchedUEsRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ListPatchedUEsRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ListPatchedUEsRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *ListPatchedUEsRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ListPatchedUEsRequest.Merge(m, src)
}
func (m *ListPatchedUEsRequest) XXX_Size() int {
	return m.Size()
}
func (m *ListPatchedUEsRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_ListPatchedUEsRequest.DiscardUnknown(m)
}

var xxx_messageInfo_ListPatchedUEsRequest proto.InternalMessageInfo
...
func (m *ListUEsResponse) GetUe() *types1.Ue {
	if m != nil {
		return m.Ue
	}
	return nil
...
func (*GetUECountRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_9942ba2f94296ec8, []int{59}
}
...
func (*GetUECountResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_9942ba2f94296ec8, []int{60}
}
...
func (*SetUECountRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_9942ba2f94296ec8, []int{61}
}
...
func (*SetUECountResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_9942ba2f94296ec8, []int{62}
}
...
func init() {
	...
	proto.RegisterType((*ModelInfoRequest)(nil), "onos.ransim.model.ModelInfoRequest")
	proto.RegisterType((*ModelInfoResponse)(nil), "onos.ransim.model.ModelInfoResponse")
	...
	proto.RegisterType((*ListPatchedCellsRequest)(nil), "onos.ransim.model.ListPatchedCellsRequest")
	...
	proto.RegisterType((*ListPatchedUEsRequest)(nil), "onos.ransim.model.ListPatchedUEsRequest")
...
var fileDescriptor_9942ba2f94296ec8 = []byte{
	...
	,
}
...
func (c *modelServiceClient) GetModelInfo(ctx context.Context, in *ModelInfoRequest, opts ...grpc.CallOption) (*ModelInfoResponse, error) {
	out := new(ModelInfoResponse)
	err := c.cc.Invoke(ctx, "/onos.ransim.model.ModelService/GetModelInfo", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedModelServiceServer) GetModelInfo(ctx context.Context, req *ModelInfoRequest) (*ModelInfoResponse, error) {
...
func _ModelService_GetModelInfo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/onos.ransim.model.ModelService/GetModelInfo",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
type CellModelClient interface {
	...
	ListPatchedCells(ctx context.Context, in *ListPatchedCellsRequest, opts ...grpc.CallOption) (CellModel_ListPatchedCellsClient, error)
}
...
func (c *cellModelClient) ListPatchedCells(ctx context.Context, in *ListPatchedCellsRequest, opts ...grpc.CallOption) (CellModel_ListPatchedCellsClient, error) {
	stream, err := c.cc.NewStream(ctx, &_CellModel_serviceDesc.Streams[2], "/onos.ransim.model.CellModel/ListPatchedCells", opts...)
	if err != nil {
		return nil, err
	}
	x := &cellModelListPatchedCellsClient{stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
type CellModel_ListPatchedCellsClient interface {
	Recv() (*ListCellsResponse, error)
	grpc.ClientStream
}

type cellModelListPatchedCellsClient struct {
	grpc.ClientStream
}

func (x *cellModelListPatchedCellsClient) Recv() (*ListCellsResponse, error) {
	m := new(ListCellsResponse)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
type CellModelServer interface {
	...
	ListPatchedCells(*ListPatchedCellsRequest, CellModel_ListPatchedCellsServer) error
}
...
func (*UnimplementedCellModelServer) ListPatchedCells(req *ListPatchedCellsRequest, srv CellModel_ListPatchedCellsServer) error {
	return status.Errorf(codes.Unimplemented, "method ListPatchedCells not implemented")
}
...
func _CellModel_ListPatchedCells_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(ListPatchedCellsRequest)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(CellModelServer).ListPatchedCells(m, &cellModelListPatchedCellsServer{stream})
}

type CellModel_ListPatchedCellsServer interface {
	Send(*ListCellsResponse) error
	grpc.ServerStream
}

type cellModelListPatchedCellsServer struct {
	grpc.ServerStream
}

func (x *cellModelListPatchedCellsServer) Send(m *ListCellsResponse) error {
	return x.ServerStream.SendMsg(m)
}
...
var _CellModel_serviceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		...
		{
			StreamName:    "ListPatchedCells",
			Handler:       _CellModel_ListPatchedCells_Handler,
			ServerStreams: true,
		},
	},
	Metadata: "onos/ransim/model/model.proto",
...
type UEModelClient interface {
	...
	ListPatchedUEs(ctx context.Context, in *ListPatchedUEsRequest, opts ...grpc.CallOption) (UEModel_ListPatchedUEsClient, error)
...
func (c *uEModelClient) ListPatchedUEs(ctx context.Context, in *ListPatchedUEsRequest, opts ...grpc.CallOption) (UEModel_ListPatchedUEsClient, error) {
	stream, err := c.cc.NewStream(ctx, &_UEModel_serviceDesc.Streams[2], "/onos.ransim.model.UEModel/ListPatchedUEs", opts...)
	if err != nil {
		return nil, err
	}
	x := &uEModelListPatchedUEsClient{stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
type UEModel_ListPatchedUEsClient interface {
	Recv() (*ListUEsResponse, error)
	grpc.ClientStream
}

type uEModelListPatchedUEsClient struct {
	grpc.ClientStream
}

func (x *uEModelListPatchedUEsClient) Recv() (*ListUEsResponse, error) {
	m := new(ListUEsResponse)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
type UEModelServer interface {
	...
	ListPatchedUEs(*ListPatchedUEsRequest, UEModel_ListPatchedUEsServer) error
...
func (*UnimplementedUEModelServer) ListPatchedUEs(req *ListPatchedUEsRequest, srv UEModel_ListPatchedUEsServer) error {
	return status.Errorf(codes.Unimplemented, "method ListPatchedUEs not implemented")
}
...
func _UEModel_ListPatchedUEs_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(ListPatchedUEsRequest)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(UEModelServer).ListPatchedUEs(m, &uEModelListPatchedUEsServer{stream})
}

type UEModel_ListPatchedUEsServer interface {
	Send(*ListUEsResponse) error
	grpc.ServerStream
}

type uEModelListPatchedUEsServer struct {
	grpc.ServerStream
}

func (x *uEModelListPatchedUEsServer) Send(m *ListUEsResponse) error {
	return x.ServerStream.SendMsg(m)
}
...
var _UEModel_serviceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		...
		{
			StreamName:    "ListPatchedUEs",
			Handler:       _UEModel_ListPatchedUEs_Handler,
			ServerStreams: true,
		},
	},
	Metadata: "onos/ransim/model/model.proto",
...
func (m *ListPatchedCellsRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *ListPatchedCellsRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ListPatchedCellsRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *ListPatchedUEsRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *ListPatchedUEsRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ListPatchedUEsRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *ListPatchedCellsRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ListPatchedUEsRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	...
	for iNdEx < l {
		...
		case 1:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.PlmnID |= github_com_nfvri_onos_api_go_onos_ransim_types.PlmnID(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
	...
	for iNdEx < l {
		...
		case 1:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.GnbID |= github_com_nfvri_onos_api_go_onos_ransim_types.GnbID(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
	...
	for iNdEx < l {
		...
		case 1:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.NCGI |= github_com_nfvri_onos_api_go_onos_ransim_types.NCGI(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *ListPatchedCellsRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ListPatchedCellsRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ListPatchedCellsRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		default:
			iNdEx = preIndex
	...
	for iNdEx < l {
		...
		case 1:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.IMSI |= github_com_nfvri_onos_api_go_onos_ransim_types.IMSI(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *ListPatchedUEsRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ListPatchedUEsRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ListPatchedUEsRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		default:
			iNdEx = preIndex
